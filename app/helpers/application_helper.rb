...
module ApplicationHelper
  ...
  def link_to_permalink(item, title, anchor=nil, style=false, nofollow=false, only_path=false, article_identifier=false)
    options = {}
    options[:class] = style if style
    options[:rel] = "nofollow" if nofollow
    options[:'data-disqus-identifier'] = article_identifier if article_identifier
